...
use pocketmine\block\MossStone;
...
class SuperFlat extends Generator{
    ...
    $this->preset = "2;7,59x1,3x3,2;1;spawn(radius=10 block=89),decoration(treecount=100 grasscount=50)";
		...
		if(isset($this->options["decoration"])){
			$ores = new Ore();
			$ores->setOreTypes([
      /**Block $material, $clusterCount, $clusterSize, $minHeight, $maxHeight*/
        ...
        new object\OreType(new EmeraldOre(), 1, 6, 0, 32),
        new object\OreType(new GlowingObsidian(), 5, 8, 0, 64),
        new object\OreType(new MossStone(), 1, 1, 0, 128),
        new object\OreType(new Obsidian(), 4, 8, 0, 64)
			]);
